...
public class KeyboardEvents : MonoBehaviour
{
    ...
    private void Update()
    {
        ProjectSettings.instance.speed = Input.GetKey(KeyCode.LeftShift) ? 5.0f : 10.0f;
        ...
        if (Input.mouseScrollDelta.y != 0
            ...
            && ProjectSettings.instance.selectedGameObject != null
            && GlobalSettings.instance.drawingMode == GlobalSettings.DrawingModes.Selecting)
            spra.rotate(ProjectSettings.instance.selectedGameObject, Input.mouseScrollDelta.y);
    }
}